...
class GlassNavbar extends StatelessWidget {
  ...
  Widget _buildFullNav(double spacing) => Row(
    ...
    children: [
      ...
      _AnimatedNavItem(text: 'Education', index: 2, onTap: onNavigationTap),
      SizedBox(width: spacing),
      _AnimatedNavItem(text: 'Learning', index: 3, onTap: onNavigationTap),
      SizedBox(width: spacing),
      _AnimatedNavItem(text: 'Works', index: 4, onTap: onNavigationTap),
      SizedBox(width: spacing),
      _AnimatedNavItem(text: 'Skills', index: 5, onTap: onNavigationTap),
      SizedBox(width: spacing),
