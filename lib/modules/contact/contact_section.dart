...
class _ContactSectionState extends State<ContactSection> {
          ...
          const SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Please email me directly at ${ProfileData.email}',
                  ),
                ),
              ],
            ),
  ...
  Widget _buildContent(ThemeData theme) => Column(
    ...
    children: [
      ...
      Text(
        'Have a project in mind? Send me a message below or email me directly at ${ProfileData.email}',
