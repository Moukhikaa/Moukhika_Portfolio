...
import 'package:polymorphism/modules/home/education_section.dart';
import 'package:polymorphism/modules/skills/skills_marquee_section.dart';
        ...
        SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Container(key: _sectionKeys[2], child: const EducationSection()),
              Container(
                key: _sectionKeys[3],
              ...
              Container(
                key: _sectionKeys[5],
                child: const SkillsMarqueeSection(),
              ),
              const _BuiltWithCuriosityLine(),
...
class _BuiltWithCuriosityLine extends StatelessWidget {
  const _BuiltWithCuriosityLine();
